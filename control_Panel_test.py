...
def main():
	...
	GPIO.add_event_detect(buttons[1], GPIO.FALLING, callback=leftUp, bouncetime=100)
	GPIO.add_event_detect(buttons[2], GPIO.FALLING, callback=leftDown, bouncetime=100)
	GPIO.add_event_detect(buttons[3], GPIO.FALLING, callback=RightUp, bouncetime=100)
